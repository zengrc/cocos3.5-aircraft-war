...
import { _decorator, Component, Node, UITransform, director, Prefab, instantiate, random } from 'cc';
import { EnemyController, Enemy_Type, Enemy_Config } from './EnemyController';
